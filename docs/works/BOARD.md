...
| WC-104 | CI: 푸시마다 테스트 실행 | codex | P2 | REVIEW |
| WC-105 | MCTS 잭 프로토타입 (오프라인 비교) | codex | P3 | IN_PROGRESS |
| WC-106 | 단일 파일 빌드 스크립트 | codex | P2 | REVIEW |
...
| WC-209 | 어려움 잭 튜닝 (smart 경찰 기준 생존율 개선) | claude | P2 | TODO |
